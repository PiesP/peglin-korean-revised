...
def _candidate_readme(
    ...
    return (
        ...
        "3. Extract this archive into the Peglin installation directory, the "
        "folder containing Peglin.exe.\n"
        "4. Start the game with BepInEx enabled and select Korean in the game "
        "language settings.\n\n"
        ...
        "and the Assembly-CSharp.dll hash asynchronously. It refuses to apply "
